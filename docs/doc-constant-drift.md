...
| `verify-agent-resumption` | a generated prompt contains `NO memory`, `KAN-21`, `.butchr-prompt.md`, `not restart the task` | **Safe.** Instructions to the agent, not observations about the world. |
