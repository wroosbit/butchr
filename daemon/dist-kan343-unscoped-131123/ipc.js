...
export function ensureButchrDir() {
...
export function onJsonLines(stream, onMessage, onError) {
...
export function writeJsonLine(socket, msg) {
    if (socket.destroyed)
        return false;
...
export function connectToDaemon(opts = {}) {
