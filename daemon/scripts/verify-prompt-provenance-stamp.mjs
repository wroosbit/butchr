...
// ---------------------------------------------------------------------------
// Every fixture below is built here: the scratch checkout, its `origin`, the
// template, the commits. So what is proved is that **the renderer, given a
// repository, produces a correct and executable stamp**. What is NOT proved,
// and cannot be by anything in this file:
//
