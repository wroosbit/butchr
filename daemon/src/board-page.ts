...
/** A board page, once identified. */
export interface BoardPage {
  /** The project key as the URL spells it, upper-cased. Null on RapidBoard. */
  projectKey: string | null;
  /** The board id. Null on RapidBoard, where it is query state. */
  boardId: string | null;
}
 ...
 */
export function boardPageFor(url: unknown): BoardPage | null {
