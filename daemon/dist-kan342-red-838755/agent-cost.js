 ...
 */
export function finishMeasurement(start, isSupervisor, readArgv = readCmdline) {
 ...
 */
export function aggregateTrees(before, after, elapsed, isSupervisor, readArgv = readCmdline) {
 ...
 */
export async function measureAgentCost(seconds, isSupervisor) {
